...
TEST_CASE("parse_decimal_U"){
    ...
    auto t = l.get_token();
    auto c = ast::Constant(t);
    REQUIRE(c.type ==  type::CType(type::IType::UInt));
...
TEST_CASE("parse_decimal_ull"){
    ...
    auto t = l.get_token();
    auto c = ast::Constant(t);
    REQUIRE(c.type ==  type::CType(type::IType::ULLong));
    REQUIRE(c.literal == "2532");
}
...
TEST_CASE("parse_decimal_lu"){
    ...
    auto t = l.get_token();
    auto c = ast::Constant(t);
    REQUIRE(c.type ==  type::CType(type::IType::ULong));
    REQUIRE(c.literal == "2532");
}
TEST_CASE("parse_dec_int"){
    ...
    auto t = l.get_token();
    auto c = ast::Constant(t);
    REQUIRE(c.type ==  type::CType(type::IType::Int));
...
TEST_CASE("parse_too_large_dec_int_target_dependent"){
    ...
    auto t = l.get_token();
    auto c = ast::Constant(t);
    REQUIRE(c.type ==  type::CType(type::IType::Long));
    REQUIRE(c.literal == "2952790015");
}
...
TEST_CASE("parse float plus double"){
    auto ss = std::stringstream(
R"(int main(){
    return 0.3f + 0.8;
})");
...
TEST_CASE("parse extended arith example"){
    auto ss = std::stringstream(
R"(int main(){
    return 3 + 4*(2.3 - 1ll);
})");
...
TEST_CASE("parse integer divisions"){
    auto ss = std::stringstream(
R"(int main(){
    return ~(3u/2u+5)/4;
})");
